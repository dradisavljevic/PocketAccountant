...
import {View, TextInput, Animated, StyleSheet, NativeSyntheticEvent, TextInputKeyPressEventData, TextInputChangeEventData, KeyboardTypeOptions} from 'react-native';
import colors from '../constants/colors';
import { RootState } from '../state/Store';

type LabelProps = { label: string, value: string, editable: boolean, maxLength?: number, keyboardType?: KeyboardTypeOptions | undefined, onKeyPress?: (e: NativeSyntheticEvent<TextInputKeyPressEventData>) => void, onChangeText?: (text: string) => void, onChange?: (e: NativeSyntheticEvent<TextInputChangeEventData>) => void};
